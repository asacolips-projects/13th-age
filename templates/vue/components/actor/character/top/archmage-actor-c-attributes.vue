  ...
  <section class="section section--attributes flexrow">
    ...
    <div class="unit unit--attributes grid grid-5col border-both">
      ...
      <div class="unit unit--has-max unit--hp">
        ...
        <archmage-h-progress name="hp" :current="actor.system.attributes.hp.value" :temp="actor.system.attributes.hp.temp" :max="actor.system.attributes.hp.max"/>
      ...
      <div class="unit unit--has-max unit--recoveries">
        ...
        <archmage-h-progress name="recoveries" :current="actor.system.attributes.recoveries.value" :max="actor.system.attributes.recoveries.max"/>
        <div class="resource flexrow">
