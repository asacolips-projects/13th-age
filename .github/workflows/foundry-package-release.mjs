...
const release_data = {
  ...
  "manifest": `https://asacolips-artifacts.s3.amazonaws.com/archmage/${system.version}/system.json`,
  "notes": `https://github.com/asacolips-projects/archmage/releases/tag/${system.version}`,
  "compatibility": {
