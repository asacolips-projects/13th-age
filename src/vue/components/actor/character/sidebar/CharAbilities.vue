<template>
  <section class="section section--abilities flexcol">
    ...
    <ul class="list list--abilities abilities">
      <li v-for="(item, index) in actor.system.abilities" :key="concat('data.abilities.', index, '.value')" class="list-item list-item--abilities ability grid grid-4col" :data-key="index">
