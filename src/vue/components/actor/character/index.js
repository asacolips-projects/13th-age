...
export { default as CharHeader } from './top/CharHeader.vue';
export { default as CharAttributes } from './top/CharAttributes.vue';

export { default as CharAbilities } from './sidebar/CharAbilities.vue';
